...
from model_wo_xcrossnet import ESMM
from basic.features import DenseFeature, SparseFeature
import torch
import os
from trainers.trainer_wo_xcrossnet import MTLTrainer 
...
model = ESMM(user_features, item_features, cvr_params={"dims": [360*10, 200*10, 80*10], "dropout": 0.2}, ctr_params={"dims": [360*10, 200*10, 80*10], "dropout": 0.2})
...
epoch = 20 #10
save_dir = f'/home/zmm/HUAWEIBEI/torch-rechub-main/examples/ranking/data/ali-ccp/saved/{formatted_time}'
